...
export const Tags: StoryFn = () => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      ...
      />
      <TagItem tag={{ id: '2', value: 'tag2', color: 'blue' }} mode="inline" />
      <TagItem tag={{ id: '3', value: 'tag3', color: 'green' }} mode="inline" />
      <TagItem tag={{ id: '1', value: 'tag', color: 'red' }} mode="list-item" />
    </div>
  );
};

export const InlineTagListStory: StoryFn = () => {
  return <InlineTagList tags={tags} />;
};
