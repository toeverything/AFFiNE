...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_AFFINE_MOBILE_NATIVE_FN_METHOD_DOCSTORAGEPOOL_DELETE_WORKSPACE
#define UNIFFI_FFIDEF_UNIFFI_AFFINE_MOBILE_NATIVE_FN_METHOD_DOCSTORAGEPOOL_DELETE_WORKSPACE
uint64_t uniffi_affine_mobile_native_fn_method_docstoragepool_delete_workspace(void*_Nonnull ptr, RustBuffer universal_id, RustBuffer path
);
#endif
...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_AFFINE_MOBILE_NATIVE_CHECKSUM_METHOD_DOCSTORAGEPOOL_DELETE_WORKSPACE
#define UNIFFI_FFIDEF_UNIFFI_AFFINE_MOBILE_NATIVE_CHECKSUM_METHOD_DOCSTORAGEPOOL_DELETE_WORKSPACE
uint16_t uniffi_affine_mobile_native_checksum_method_docstoragepool_delete_workspace(void
