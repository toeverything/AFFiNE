...
export class HelloEdgelessBlockComponent extends toGfxBlockComponent(
  HelloBlockComponent
) {
...
export const HelloBlockInteraction =
  GfxViewInteractionExtension<HelloEdgelessBlockComponent>(
...
declare global {
  interface HTMLElementTagNameMap {
    'wb-hello-edgeless': HelloEdgelessBlockComponent;
  }
}
