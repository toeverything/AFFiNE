...
export abstract class SearchProvider {
  abstract provider: SearchProviderName;
  /**
   * Create a new search index table.
   */
  abstract createTable(table: SearchTable, mappingFile: string): Promise<void>;
  /**
  ...
  protected get config() {
    return this.AFFiNEConfig.search;
  }

  protected get configured() {
    return this.config.enabled && this.config.provider === this.provider;
  }
