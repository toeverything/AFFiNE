...
AFFiNE.ENV_MAP = {
  ...
  OIDC_ISSUER: 'plugins.oauth.providers.oidc.issuer',
  OIDC_CLIENT_ID: 'plugins.oauth.providers.oidc.clientId',
  OIDC_CLIENT_SECRET: 'plugins.oauth.providers.oidc.clientSecret',
  OIDC_SCOPE: 'plugins.oauth.providers.oidc.args.scope',
  OIDC_CLAIM_MAP_USERNAME: 'plugins.oauth.providers.oidc.args.claim_id',
  OIDC_CLAIM_MAP_EMAIL: 'plugins.oauth.providers.oidc.args.claim_email',
  OIDC_CLAIM_MAP_NAME: 'plugins.oauth.providers.oidc.args.claim_name',
