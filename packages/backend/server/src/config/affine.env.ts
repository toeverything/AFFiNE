...
AFFiNE.ENV_MAP = {
  ...
  OIDC_ISSUER: 'plugins.oidc.issuer',
  OIDC_CLIENT_ID: 'plugins.oidc.clientId',
  OIDC_CLIENT_SECRET: 'plugins.oidc.clientSecret',
  OIDC_SCOPE: 'plugins.oidc.args.scope',
  OIDC_CLAIMS_MAP_USERNAME: 'plugins.oidc.args.id',
  OIDC_CLAIMS_MAP_EMAIL: 'plugins.oidc.args.email',
  OIDC_CLAIMS_MAP_NAME: 'plugins.oidc.args.name',
