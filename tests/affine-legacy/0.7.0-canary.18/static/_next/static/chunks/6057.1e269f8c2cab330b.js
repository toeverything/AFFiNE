    ...
    16057: function (t, i, C) {
      ...
      let n = () =>
        ...
        g = (0, o.zo)('a')(() => ({
          ...
          letterSpacing: '1px',
          ':visited': { color: 'var(--affine-text-primary-color)' },
          ':hover': { background: 'rgba(68, 97, 242, 0.1)' },
          ':not(:last-of-type)': { marginRight: '48px' },
          svg: {
            width: '48px',
            height: '48px',
            marginRight: '24px',
            color: 'var(--affine-primary-color)',
            ...(0, o.Ls)({ vertical: !0, position: { left: '26px' } }),
          },
          p: {
            width: '100%',
            height: '24px',
        ...
        s = (0, o.zo)('a')(() => ({
          ...
          svg: { width: '22px', color: 'var(--affine-primary-color)' },
        ...
        u = (0, o.zo)('div')(() => ({
          ...
          a: {
            ...
            padding: '0 8px',
            ':visited': { color: 'var(--affine-icon-color)' },
            ':first-of-type': {
        ...
        y = t => {
          let { open: i, onClose: C, logoSrc: h } = t,
            c = (0, r.X)(),
            a = [
              {
                icon: (0, e.tZ)(n, {}),
            ...
            children: (0, e.BX)(o.AB, {
              ...
              children: [
                ...
                (0, e.tZ)(o.A0, {
                  ...
                  children: a.map(t => {
                    let { icon: i, title: C, subTitle: r, link: o } = t;
                    return (0, e.BX)(
                      g,
                      {
                        href: o,
                ...
                (0, e.tZ)(w, {
                  children: c['Get in touch! Join our communities'](),
                }),
                (0, e.tZ)(o.A0, {
                  justifyContent: 'center',
                  children: m.map(t => {
                    let { icon: i, title: C, link: r } = t;
                    return (0, e.BX)(
                      s,
                      {
                        href: r,
                        target: '_blank',
                        children: [i, (0, e.tZ)('p', { children: C })],
                      },
                      C
                    );
                  }),
                ...
                (0, e.BX)(Z, {
                  children: [
                    (0, e.BX)('p', {
                      children: ['Copyright \xa9 ', d, ' Toeverything'],
                    }),
                    (0, e.BX)(u, {
                      children: [
                        (0, e.tZ)('a', {
...
//# sourceMappingURL=6057.1e269f8c2cab330b.js.map
